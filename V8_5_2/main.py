...
MAX_PIV_FRAMES = 10   # set to e.g. 200 for testing
# ==================================================
...
# Render colorbar once
colorbar_img = render_colorbar_image_jet_reversed(
    vmin, vmax, label="Velocity (m/s)"
)

original_frame = first_frame.copy() 

# Overlay streamlines (vector)
